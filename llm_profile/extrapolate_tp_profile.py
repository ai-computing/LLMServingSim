...
def main():
    ...
    parser.add_argument("--target-tp", nargs="+", type=int, default=[4, 8],
                        help="TP sizes to generate (must be powers of 2, > 2)")
    parser.add_argument("--hw", default=None, help="Limit to this hardware (e.g. A6000)")
    ...
    if not args.dry_run:
        ...
        print('    --model meta-llama/Llama-3.1-8B --hardware A6000 \\')
        print('    --tp-size "1, 2, 4, 8" \\')
